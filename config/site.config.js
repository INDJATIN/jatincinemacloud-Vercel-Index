...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'jatincinema@indjatin.onmicrosoft.com',
  ...
  baseDirectory: '/JatinCinema [All Database]',
  ...
  protectedRoutes: ['/JatinCinema [All Database]', '/🥟 Some test files/Protected route'],
